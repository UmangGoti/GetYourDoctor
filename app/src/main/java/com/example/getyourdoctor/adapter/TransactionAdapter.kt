...
class TransactionAdapter(val context: Context, transactionDataList: ArrayList<TransactionData>) :
    RecyclerView.Adapter<TransactionAdapter.TransactionViewholderClass>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): TransactionAdapter.TransactionViewholderClass {
    ...
    override fun onBindViewHolder(
        holder: TransactionAdapter.TransactionViewholderClass,
        position: Int
    ) {
